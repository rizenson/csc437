...
const yt = (s) => new ct(typeof s == "string" ? s : s + "", void 0, K),
  E = (s, ...t) => {
    const e =
      s.length === 1
        ? s[0]
...
Symbol.metadata ?? (Symbol.metadata = Symbol("metadata")),
  y.litPropertyMetadata ?? (y.litPropertyMetadata = new WeakMap());
class S extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, r) {
    const { get: o, set: i } = vt(this.prototype, t) ?? {
      get() {
        return this[e];
      },
      set(n) {
    ...
    return {
      ...
      set(n) {
        ...
        i.call(this, n), this.requestUpdate(t, a, r);
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  static finalize() {
    ...
    if (
      ((this.finalized = !0), this._$Ei(), this.hasOwnProperty(T("properties")))
    ) {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of r) e.unshift(tt(o));
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const n = r.getPropertyOptions(o),
        a =
          typeof n.converter == "function"
            ...
            : D;
      (this._$Em = o),
        (this[o] = a.fromAttribute(e, n.type)),
        (this._$Em = null);
    }
  }
  requestUpdate(t, e, r) {
...
(S.elementStyles = []),
  ...
  (S[T("elementProperties")] = new Map()),
  (S[T("finalized")] = new Map()),
  W == null || W({ ReactiveElement: S }),
 ...
 */ const P = globalThis,
  I = P.trustedTypes,
  st = I ? I.createPolicy("lit-html", { createHTML: (s) => s }) : void 0,
  ht = "$lit$",
  ...
  $ = document,
  O = () => $.createComment(""),
  N = (s) => s === null || (typeof s != "object" && typeof s != "function"),
  pt = Array.isArray,
  Ct = (s) =>
    pt(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function",
  q = `[ 	
\f\r]`,
  C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  ot = /-->/g,
      ...
      (p = n.lastIndex),
        n === C
          ? u[1] === "!--"
            ...
            ? (n = it)
            : u[2] !== void 0
            ? (mt.test(u[2]) && (o = RegExp("</" + u[2], "g")), (n = _))
            : u[3] !== void 0 && (n = _)
          : n === _
          ? u[0] === ">"
            ? ((n = o ?? C), (d = -1))
            : u[1] === void 0
            ? (d = -2)
            : ((d = n.lastIndex - u[2].length),
              (c = u[1]),
              (n = u[3] === void 0 ? _ : u[3] === '"' ? lt : nt))
          : n === lt || n === nt
          ? (n = _)
          : n === ot || n === it
          ? (n = C)
          : ((n = _), (o = void 0));
    const f = n === _ && s[a + 1].startsWith("/>") ? " " : "";
    i +=
      n === C
        ? l + kt
        : d >= 0
        ? (r.push(c), l.slice(0, d) + ht + l.slice(d) + b + f)
        : l + b + (d === -2 ? a : f);
  }
  return [gt(s, i + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), r];
};
class M {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    for (; (o = w.nextNode()) !== null && l.length < a; ) {
      if (o.nodeType === 1) {
          ...
          for (const d of o.getAttributeNames())
            if (d.endsWith(ht)) {
              ...
              l.push({
                ...
                strings: f,
                ctor:
                  R[1] === "." ? Nt : R[1] === "?" ? Mt : R[1] === "@" ? Ut : j,
              }),
                o.removeAttribute(d);
            } else
              d.startsWith(b) &&
                (l.push({ type: 6, index: i }), o.removeAttribute(d));
        if (mt.test(o.tagName)) {
          const d = o.textContent.split(b),
            p = d.length - 1;
          if (p > 0) {
        ...
        if (o.data === ut) l.push({ type: 2, index: i });
        else {
          let d = -1;
          for (; (d = o.data.indexOf(b, d + 1)) !== -1; )
            l.push({ type: 7, index: i }), (d += b.length - 1);
        }
      i++;
    }
  }
...
function A(s, t, e = s, r) {
  ...
  return (
    (o == null ? void 0 : o.constructor) !== i &&
      ((a = o == null ? void 0 : o._$AO) == null || a.call(o, !1),
      i === void 0 ? (o = void 0) : ((o = new i(s)), o._$AT(s, e, r)),
      r !== void 0 ? ((e._$Co ?? (e._$Co = []))[r] = o) : (e._$Cl = o)),
    o !== void 0 && (t = A(s, o._$AS(s, t.values), o, r)),
    t
  );
}
class Ot {
  ...
  u(t) {
    const {
      ...
      o = ((t == null ? void 0 : t.creationScope) ?? $).importNode(e, !0);
    w.currentNode = o;
    let i = w.nextNode(),
      n = 0,
      a = 0,
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let c;
        l.type === 2
          ? (c = new U(i, i.nextSibling, this, t))
          : l.type === 1
          ? (c = new l.ctor(i, l.name, l.strings, this, t))
          : l.type === 6 && (c = new Rt(i, this, t)),
          this._$AV.push(c),
          (l = r[++a]);
      }
      n !== (l == null ? void 0 : l.index) && ((i = w.nextNode()), n++);
    }
...
class U {
    ...
    const { values: e, _$litType$: r } = t,
      o =
        typeof r == "number"
          ? this._$AC(t)
          : (r.el === void 0 &&
              (r.el = M.createElement(gt(r.h, r.h[0]), this.options)),
            r);
    if (((i = this._$AH) == null ? void 0 : i._$AD) === o) this._$AH.p(e);
    else {
      const n = new Ot(o, this),
        a = n.u(this.options);
  ...
  k(t) {
    ...
    for (const i of t)
      o === e.length
        ? e.push((r = new U(this.S(O()), this.S(O()), this, this.options)))
        : (r = e[o]),
        r._$AI(i),
        o++;
  ...
  _$AI(t, e = this, r, o) {
    ...
    if (i === void 0)
      ...
      for (t = i[0], l = 0; l < i.length - 1; l++)
        (c = A(this, a[r + l], e, l)),
          c === x && (c = this._$AH[l]),
          n || (n = !N(c) || c !== this._$AH[l]),
          c === h ? (t = h) : t !== h && (t += (c ?? "") + i[l + 1]),
          (this._$AH[l] = c);
    }
    n && !o && this.j(t);
  }
...
const G = P.litHtmlPolyfillSupport;
G == null || G(M, U),
  (P.litHtmlVersions ?? (P.litHtmlVersions = [])).push("3.1.2");
const Bt = (s, t, e) => {
  const r = (e == null ? void 0 : e.renderBefore) ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const i = (e == null ? void 0 : e.renderBefore) ?? null;
    r._$litPart$ = o = new U(t.insertBefore(O(), i), i, void 0, e ?? {});
  }
  return o._$AI(s), o;
};
/**
 ...
 */ class g extends S {
  ...
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = Bt(e, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var t;
...
(g._$litElement$ = !0),
  (g.finalized = !0),
  (dt = globalThis.litElementHydrateSupport) == null ||
    dt.call(globalThis, { LitElement: g });
  ...
  return (t, e) =>
    typeof e == "object"
      ...
      : ((r, o, i) => {
          ...
          return (
            o.constructor.createProperty(i, n ? { ...r, wrapped: !0 } : r),
            n ? Object.getOwnPropertyDescriptor(o, i) : void 0
          );
        })(s, t, e);
}
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ function Ht(s) {
  return ft({ ...s, state: !0, attribute: !1 });
}
var Lt = Object.defineProperty,
  jt = Object.getOwnPropertyDescriptor,
  zt = (s, t, e, r) => {
    for (
      var o = r > 1 ? void 0 : r ? jt(t, e) : t, i = s.length - 1, n;
      i >= 0;
      i--
    )
      (n = s[i]) && (o = (r ? n(t, e, o) : n(o)) || o);
    return r && o && Lt(t, e, o), o;
  };
let F = class extends g {
  constructor() {
    super(...arguments), (this._show = !1);
  }
  show() {
  ...
  render() {
    return m`<div class="rule_box show">
...
var Wt = Object.defineProperty,
  ...
  Gt = (s, t, e, r) => {
    for (
      var o = r > 1 ? void 0 : r ? qt(t, e) : t, i = s.length - 1, n;
      i >= 0;
      i--
    )
      (n = s[i]) && (o = (r ? n(t, e, o) : n(o)) || o);
    return r && o && Wt(t, e, o), o;
  };
let H = class extends g {
  constructor() {
    super(...arguments),
      (this.numberOfSymbols = this.getNumberOfSymbols()),
      (this.listOfNums = [...Array(this.numberOfSymbols + 1).keys()]),
      (this.allZeros = this.getAllZeros()),
      (this.totalCards = 2 ** this.numberOfSymbols - 1),
      (this.deck = [...Array(this.totalCards)].map((s, t) => t + 1)),
      (this.hintsGiven = 0),
      (this.cardsToShow = this.getCards()),
      (this.solution = this.findSolution()),
      (this.abc = this.darkMode());
  }
  getNumberOfSymbols() {
    var t;
    let s =
      (t = document.cookie
        .split("; ")
        .find((e) => e.startsWith("numberOfSymbols="))) == null
        ? void 0
        : t.split("=")[1];
    return s ? Number(s) : 6;
  }
  ...
  getCards() {
    let s = [];
    for (let t = 0; t < this.numberOfSymbols + 1; t++)
      s.push([this.getCard(), !1]);
    return s;
  }
  startGame() {
    (this.totalCards = 2 ** this.numberOfSymbols - 1),
      ...
      (this.cardsToShow = this.getCards()),
      (this.solution = this.findSolution());
    for (let s = 0; s < this.cardsToShow.length; s++)
      (document.getElementsByTagName(
        "main-game"
      )[0].shadowRoot.children[1].children[s].children[0].style.display =
        "table-row-group"),
        (document.getElementsByTagName(
          "main-game"
        )[0].shadowRoot.children[1].children[s].children[0].style.borderColor =
          "#555");
    (document.getElementsByTagName(
      "main-game"
  ...
  hasDuplicate(s) {
    let t = s.split(" ");
    return s.length < 3 ? !0 : new Set(t).size !== t.length;
  }
  findSolution() {
    let s = this.getCombinations(this.cardsToShow, 4, this.numberOfSymbols + 1);
    for (let t = 0; t < s.length; t++)
      if (!this.hasDuplicate(s[t]) && this.checkValid(s[t])) return s[t];
  }
  darkMode() {
    var t;
    let s =
      (t = document.cookie
        .split("; ")
        .find((e) => e.startsWith("darkMode="))) == null
        ? void 0
        : t.split("=")[1];
    console.log("i am reading dark mode as " + s),
      s && s == "true"
        ? (document
            .querySelector(":root")
  ...
  checkValid(s) {
    ...
    for (let r = 0; r < t.length; r++)
      for (let o = 0; o < e.length; o++) e[o] += parseInt(t[r][o]);
    for (let r = 0; r < e.length; r++) if (e[r] % 2 == 1) return !1;
    return !0;
  }
  getCombinations(s, t, e) {
    return [...Array(e).keys()]
      .reduce((r) => s.concat(r.flatMap((o) => s.map((i) => o + " " + i))), [])
      .filter((r) => r.length >= t);
  }
  getCard() {
    let s = Math.floor(Math.random() * this.totalCards),
      t = this.deck[s].toString(2);
    return (
      (t = t.padStart(this.numberOfSymbols, "0")),
      (this.totalCards -= 1),
      this.deck.splice(s, 1),
      t
    );
  }
  shuffle() {
    console.log("shuffle");
    let s = this.cardsToShow;
    for (let t = s.length - 1; t > 0; t--) {
      const e = Math.floor(Math.random() * (t + 1));
      [s[t], s[e]] = [s[e], s[t]];
    }
    this.cardsToShow = s;
    for (let t = 0; t < this.cardsToShow.length; t++)
      this.cardsToShow[t][1] == !0
        ? (document.getElementsByTagName(
            "main-game"
  ...
  select(s) {
    document.getElementsByTagName("main-game")[0].shadowRoot.children[1]
      .children[s].children[0].style.borderColor == "red"
      ? ((document.getElementsByTagName(
          "main-game"
        )[0].shadowRoot.children[1].children[s].children[0].style.borderColor =
          "#555"),
        (this.cardsToShow[s][1] = !1))
      : ((document.getElementsByTagName(
          "main-game"
        )[0].shadowRoot.children[1].children[s].children[0].style.borderColor =
          "red"),
        (this.cardsToShow[s][1] = !0)),
      this.checkSolution();
  }
  checkIfAnySelected() {
    for (let s = 0; s < this.cardsToShow.length; s++)
      if (this.cardsToShow[s][1] == !0) return !0;
    return !1;
  }
  checkSolution() {
    if (this.checkIfAnySelected()) {
      let s = [0, 0, 0, 0, 0, 0];
      for (let e = 0; e < this.cardsToShow.length; e++)
        if (this.cardsToShow[e][1])
          for (let r = 0; r < s.length; r++)
            s[r] += parseInt(this.cardsToShow[e][0][r]);
      let t = !0;
      for (let e = 0; e < s.length; e++) s[e] % 2 == 1 && (t = !1);
      t == !1
  ...
  isValid() {
    let s = [];
    for (let e = 0; e < this.cardsToShow.length; e++)
      this.cardsToShow[e][1] && s.push(e);
    for (var t = s.length - 1; t >= 0; t--) this.cardsToShow.splice(s[t], 1);
    if (this.numberOfSymbols + 1 - this.cardsToShow.length > this.totalCards)
      for (; this.totalCards != 0; )
        console.log(this.totalCards),
          this.cardsToShow.push([this.getCard(), !1]);
    else
      for (; this.cardsToShow.length != this.numberOfSymbols + 1; )
        console.log(this.totalCards),
          this.cardsToShow.push([this.getCard(), !1]);
    for (let e = 0; e < this.cardsToShow.length; e++)
      this.cardsToShow[e][1] == !0
        ? (document.getElementsByTagName(
            "main-game"
          )[0].shadowRoot.children[1].children[
            e
    ...
    if (this.cardsToShow.length < this.numberOfSymbols + 1)
      for (var t = this.cardsToShow.length; t < this.numberOfSymbols + 1; t++)
        document.getElementsByTagName(
          "main-game"
        )[0].shadowRoot.children[1].children[t].children[0].style.display =
          "none";
    this.cardsToShow.length != 0
      ? ((this.solution = this.findSolution()), (this.hintsGiven = 0))
      : (document.getElementsByTagName(
          "main-game"
  ...
  inList(s, t) {
    for (let e = 0; e < t.length; e++) if (t[e][0] == s[0]) return !0;
    return !1;
  }
  showSolution() {
    let s = this.solution ? this.solution.split(" ") : [];
    for (let t = 0; t < s.length; t++) s[t] = s[t].split(",");
    for (let t = 0; t < this.cardsToShow.length; t++)
      this.inList(this.cardsToShow[t], s)
        ? (document.getElementsByTagName(
            "main-game"
          )[0].shadowRoot.children[1].children[
            t
  ...
  giveHint() {
    ...
    for (let t = 0; t < s.length; t++) s[t] = s[t].split(",");
    for (let t = 0; t < this.cardsToShow.length; t++)
      this.cardsToShow[t][0] == s[this.hintsGiven][0] &&
        (document.getElementsByTagName(
          "main-game"
        )[0].shadowRoot.children[1].children[t].children[0].style.borderColor =
          "blue");
    this.hintsGiven += 1;
  }
  render() {
    ...
    let s =
      (e = document.cookie
        .split("; ")
        .find((r) => r.startsWith("imageStyle="))) == null
        ? void 0
        : e.split("=")[1];
    const t = (r) => m`
        <button
        ...
        >
          <img
            src="images/cards/${this.numberOfSymbols}_${s || "dot"}_${
      this.cardsToShow.length > r ? this.cardsToShow[r][0] : this.allZeros
    }.png"
          />
        </button>
      `;
    return m`<div class="cards_remaining">
...
var Vt = Object.defineProperty,
  ...
  Jt = (s, t, e, r) => {
    for (
      var o = r > 1 ? void 0 : r ? Ft(t, e) : t, i = s.length - 1, n;
      i >= 0;
      i--
    )
      (n = s[i]) && (o = (r ? n(t, e, o) : n(o)) || o);
    return r && o && Vt(t, e, o), o;
  };
let L = class extends g {
  constructor() {
    super(...arguments),
      (this._show = !1),
      (this.refresh = !1),
      (this.kindsOfCards = [4, 6, 8, 10]),
      (this.imageStyles = ["dot", "skeleton", "butterfly", "ladybug"]),
      (this.darkMode = this.getDM()),
      (this.t = this.setDarkMode(this.darkMode)),
      (this.hardMode = !1);
  }
  show() {
    var r;
    ...
    let s =
        (r = document.cookie
          .split("; ")
          .find((o) => o.startsWith("imageStyle="))) == null
          ? void 0
          : r.split("=")[1],
      t = "",
      e = document
    ...
    for (let o = 0; o < e.length; o++)
      e[o].selected &&
        ((document.cookie = "imageStyle=" + e[o].id), (t = e[o].id));
    s && s != t && (this.refresh = !0),
      document
        .getElementById("settings-box")
        .shadowRoot.firstChild.nextSibling.classList.add("show"),
      this.refresh && location.reload();
  }
  getDM() {
    var t;
    let s =
  ...
  setDarkMode(s) {
    (document.cookie = "darkMode=" + s), new H().darkMode();
  }
  toggleDarkMode() {
  ...
  toggleHardMode() {
    ...
    if (
      ...
      let r =
        (t = document.getElementsByTagName("main-game")[0].shadowRoot) == null
          ? void 0
          : t.children[1].getElementsByClassName("image-button");
      for (let o = 0; o < r.length; o++) {
        let i = Math.floor(Math.random() * 3 + 1);
        i == 1
          ? (r[o].style.transform = "scaleX(-1)")
          : i == 2
          ? (r[o].style.transform = "scaleY(-1)")
          : i == 3
          ? (r[o].style.transform = "scale(-1)")
          : (r[o].style.transform = "scale(1)");
      }
    } else {
      let r =
        (e = document.getElementsByTagName("main-game")[0].shadowRoot) == null
          ? void 0
          : e.children[1].getElementsByClassName("image-button");
      for (var s in r) r[s].style.transform = "scale(1)";
    }
  }
  colors(s, t) {
    let e = this.kindsOfCards.indexOf(s),
      r = t.shadowRoot.children[0]
        .getElementsByClassName("num_colors")[0]
        .getElementsByClassName("color_button");
    if ((console.log(r[e].classList), r[e].classList.contains("selectedW"))) {
      for (let o = 0; o < r.length; o++)
        r[o].classList.contains("selectedB") &&
          (r[o].classList.remove("selectedB"), r[o].classList.add("selectedW"));
      r[e].classList.remove("selectedW"), r[e].classList.add("selectedB");
    }
    (document.cookie = "numberOfSymbols=" + s), (this.refresh = !0);
  }
  getNumberOfSymbols() {
    var t;
    let s =
...
L.styles = E`
  ...
  `;
L = Jt([k("settings-box")], L);
const Xt = "http://localhost:3000/api";
function bt(s) {
  return `${Xt}${s}`;
}
var Zt = Object.defineProperty,
  ...
  z = (s, t, e, r) => {
    for (
      var o = r > 1 ? void 0 : r ? Kt(t, e) : t, i = s.length - 1, n;
      i >= 0;
      i--
    )
      (n = s[i]) && (o = (r ? n(t, e, o) : n(o)) || o);
...
let v = class extends g {
  constructor() {
    super(...arguments),
      (this.path = `/profile/${this.getUserId()}`),
      (this.abc = this.darkMode());
  }
  getUserId() {
    var s;
    return (s = document.cookie
      .split("; ")
      .find((t) => t.startsWith("userid="))) == null
      ? void 0
      : s.split("=")[1];
  }
  darkMode() {
    ...
    let s = new L(),
      t =
        (e = document.cookie
          .split("; ")
          .find((r) => r.startsWith("darkMode="))) == null
          ? void 0
          : e.split("=")[1];
    console.log(t), s.setDarkMode(!!(t && t == "true"));
  }
  render() {
    const s = this.profile || { userid: "", name: "" },
      { userid: t, name: e, password: r } = s,
      o = e.split(" ")[0];
    return m`
      <section>
  ...
  _fetchData(s) {
    fetch(bt(s))
      .then((t) => (t.status === 200 ? t.json() : null))
      .then((t) => {
        t && (this.profile = t);
      });
  }
  connectedCallback() {
    console.log(this.path),
      this.path && this._fetchData(this.path),
      super.connectedCallback();
  }
  attributeChangedCallback(s, t, e) {
    s === "path" && t !== e && t && this._fetchData(e),
      super.attributeChangedCallback(s, t, e);
  }
};
v.styles = [
  E`
...
z([ft()], v.prototype, "path", 2);
z([Ht()], v.prototype, "profile", 2);
v = z([k("user-profile")], v);
let J = class extends v {
  ...
  _handleSubmit(s) {
    ...
    const t = s.target,
      e = new FormData(t);
    let r = Array.from(e.entries()).map(([i, n]) => (n === "" ? [i] : [i, n]));
    const o = Object.fromEntries(r);
    console.log("Submitting Form", o),
      this._putData(o),
      (document.getElementsByTagName("user-profile")[0].style.display = "grid"),
      (document.getElementsByTagName("user-profile-edit")[0].style.display =
        "none"),
  ...
  _putData(s) {
    var e;
    const t =
      (e = document.cookie.split("; ").find((r) => r.startsWith("userid="))) ==
      null
        ? void 0
        : e.split("=")[1];
    fetch(bt(`/profiles/${t}`), {
      ...
      .then((r) => {
        r && (console.log("PUT request successful:", r), (this.profile = r));
      })
      .catch((r) => console.log("Failed to POST form data", r));
  }
};
J.styles = [
  ...v.styles,
...
var Yt = Object.defineProperty,
  ...
  te = (s, t, e, r) => {
    for (
      ...
      (n = s[i]) && (o = (r ? n(t, e, o) : n(o)) || o);
    return r && o && Yt(t, e, o), o;
  };
let X = class extends g {
  getUserId() {
    var t;
    let s =
      (t = document.cookie.split("; ").find((e) => e.startsWith("userid="))) ==
      null
        ? void 0
        : t.split("=")[1];
    return s && s != "''" ? s : null;
